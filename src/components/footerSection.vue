        ...
        <div class="row">
          ...
          <div class="col-md-8 col-xs-12 mt-3">
            <div class="row">
              ...
              <div class="col-md-2">
                <font-awesome-icon :icon="['fab', 'twitter']" class="fa-x" />
                twitter
              </div>
              <div class="col-md-2">
                <font-awesome-icon :icon="['fab', 'instagram']" class="fa-x" />
                instagram
              </div>
              <div class="col-md-2">
                <font-awesome-icon :icon="['fa', 'phone']" class="fa-x" />
                youtube
              </div>
            </div>
          </div>
      ...
      lists: [
        {
          ...
          content: "1234 Street Name"
        },
        {
          icon: ["fa", "eye-dropper"],

          content: "City, AA 99999"
        },
        {
          icon: ["fa", "envelope"],

          content: "support@mobirise.com"
        },
        {
          icon: ["fa", "phone"],
